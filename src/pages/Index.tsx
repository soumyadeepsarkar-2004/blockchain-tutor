...
// Define static enrolled courses
...
// Define static recommended courses
...
const Index = () => {
  ...
  useEffect(() => {
    // Scroll to top when component mounts or user state changes
    window.scrollTo(0, 0);
  ...
  }, [user]); // Re-run effect when user changes (after login/logout)
                          ...
                          <div className="flex flex-col h-full">
                            ...
                            <div className="mt-auto">
                              <Link to={`/courses/${course.id}`}>
                                <Button className="bg-[#0A84FF] hover:bg-[#0055D4] text-white">
                                  Resume Course
